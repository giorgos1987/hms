                ...
                <div class="box-body">
					<form method="post">
						<div class="form-group">
						  <div class="row">
							<div class="col-md-2">
							<label><?php echo lang('filter_by_room_type');?></label>
							...
							<div class="col-md-2">
							<!-- gpap fix the problem with autorefreshing all the time change type="button" from text -->
							<label><?php echo lang('check_in');?></label>	<input  type="button"
								 name="check_in" value="<?php echo @$_POST['check_in']?>" class="form-control datepicker" onchange="this.form.submit();" placeholder='<?php echo lang('check_in');?>' autocomplete="off" />
							</div>
							<div class="col-md-2">
								<!-- gpap fix the problem with autorefreshing all the time change type="button" from text -->
							<label><?php echo lang('check_out');?></label>	<input  type="button"
								 name="check_out" value="<?php echo @$_POST['check_out']?>" class="form-control datepicker" onchange="this.form.submit();" placeholder='<?php echo lang('check_out');?>' autocomplete="off" />
							</div>
							<div class="col-md-2">
														<label><?php echo lang('filter_by_payment_status');?></label>

								<select name="payment_status" class="form-control" onchange="this.form.submit();">
									<option value="">--<?php echo lang('filter_by_all')?>--</option>
							...
							<div class="col-md-2">
							<label><?php echo lang('filter_by_booking_status');?></label>
							...
							<div class="col-md-2">
							<!-- gpap fix the problem with autorefreshing all the time change type="button" from text -->
							<label><?php echo lang('booking_date');?></label>	<input  type="button" name="ordered_on" value="<?php echo @$_POST['ordered_on']?>" class="form-control datepicker" onchange="this.form.submit();" placeholder='<?php echo lang('booking_date');?>' autocomplete="off" />
							</div>
						  </div>		
						</div>
					</form>	
