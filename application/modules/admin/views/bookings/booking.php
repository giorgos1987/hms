...
<section class="content-header">
 ...
 <div class="row" style="padding:20px;">
		 	<div class="col-md-5 pull-right">
					<div class="col-md-6">
						<select name="booking_status" class="form-control" id="booking_status" data-toggle="tooltip" title="Αλλαγή Κατάστασης Κράτησης - Change Booking Status" >
					...
					<div class="col-md-6">
						<select name="payment_status" class="form-control" id="payment_status" data-toggle="tooltip" title="Αλλαγή Κατάστασης Πληρωμής- Change Payment Status" >
