...
<script src='<?php echo base_url('assets/admin/')?>/plugins/fullcalendar/lib/moment.min.js'></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.js" type="text/javascript"></script>
<script src="<?php echo base_url('assets/admin')?>/plugins/fullcalendar/fullcalendar.js" type="text/javascript"></script>
<script src="<?php echo base_url('assets/admin')?>/plugins/fullcalendar/locale/el.js" type="text/javascript"></script>
<!-- gpap9063 -->
<script type="text/javascript">
      ...
      $(function () {
        ...
        $('#calendar').fullCalendar({
          ...
          events: [
            <?php foreach($calendar_result as $key	=> $val	){?>
			{
              ...
              start: '<?php echo $key;?>',
              backgroundColor: "<?php echo $setting->unoccupied="green"; ?>", //red <?php echo $setting->unoccupied ?>
              borderColor: "#FFF" //red
            },
			{
              title: '<?php echo lang('booked');?> - <?php echo $val['unavailable'];?>',
              start: '<?php echo $key;?>',
              backgroundColor: "<?php echo $setting->occupied="red" ?>", //red <?php echo $setting->occupied ?>
              borderColor: "#FFF" //red
            },
           <?php } ?> 
          ],
        ...
        $(".fc-past").css("background-color", "#313030");
        $(".fc-today").css("background-color", "#bdbbaf");
